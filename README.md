...
To run the theoretical validation case, the  file should then be opened in MATLAB Simulink and requires the download of the [Simscape](https://www.mathworks.com/products/simscape.html) package.
