...
To run the theoretical validation case, the file [power_microgrid_v3_analytic](Analytic Validation/power_microgrid_v3_analytic.slxc) should then be opened in MATLAB Simulink and requires the download of the [Simscape](https://www.mathworks.com/products/simscape.html) package.
